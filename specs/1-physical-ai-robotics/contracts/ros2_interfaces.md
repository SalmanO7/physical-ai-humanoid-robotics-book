...
This directory will contain the ROS 2 message (`.msg`), service (`.srv`), and action (`.action`) definitions that serve as the API contracts for the Physical AI & Humanoid Robotics system.
...
These definitions will be refined as the ROS 2 packages are developed.