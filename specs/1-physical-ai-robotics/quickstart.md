...
This quickstart guide provides a basic overview to get the Physical AI & Humanoid Robotics project up and running in a simulated environment. For detailed setup and development, refer to the respective module documentation.
...
-   Refer to `specs/1-physical-ai-robotics/plan.md` for detailed architectural decisions.
-   Check `specs/1-physical-ai-robotics/tasks.md` (once generated) for implementation tasks.